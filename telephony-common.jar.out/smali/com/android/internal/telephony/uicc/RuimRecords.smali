...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/internal/telephony/uicc/RuimRecords$EfCsimMlplLoaded;,
        Lcom/android/internal/telephony/uicc/RuimRecords$EfCsimMsplLoaded;,
...
.field private static final EVENT_SET_MDN_DONE:I = 0x20
...
.field private mEprlVersion:Ljava/lang/String;
...
.field private mMlplVersion:Ljava/lang/String;

.field private mMsplVersion:Ljava/lang/String;
...
.method static synthetic -get3(Lcom/android/internal/telephony/uicc/RuimRecords;)Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/android/internal/telephony/uicc/RuimRecords;->mMlplVersion:Ljava/lang/String;
...
.method static synthetic -get4(Lcom/android/internal/telephony/uicc/RuimRecords;)Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/android/internal/telephony/uicc/RuimRecords;->mMsplVersion:Ljava/lang/String;

    return-object v0
.end method

.method static synthetic -get5(Lcom/android/internal/telephony/uicc/RuimRecords;)Ljava/lang/String;
    .locals 1
...
.method static synthetic -set6(Lcom/android/internal/telephony/uicc/RuimRecords;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object p1, p0, Lcom/android/internal/telephony/uicc/RuimRecords;->mMlplVersion:Ljava/lang/String;

    return-object p1
.end method

.method static synthetic -set7(Lcom/android/internal/telephony/uicc/RuimRecords;Ljava/lang/String;)Ljava/lang/String;
    .locals 0

    iput-object p1, p0, Lcom/android/internal/telephony/uicc/RuimRecords;->mMsplVersion:Ljava/lang/String;

    return-object p1
.end method

.method static synthetic -set8(Lcom/android/internal/telephony/uicc/RuimRecords;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
...
.method private fetchRuimRecords()V
    ...
    .line 914
    new-instance v1, Lcom/android/internal/telephony/uicc/RuimRecords$EfRuimIdLoaded;

    invoke-direct {v1, p0, v5}, Lcom/android/internal/telephony/uicc/RuimRecords$EfRuimIdLoaded;-><init>(Lcom/android/internal/telephony/uicc/RuimRecords;Lcom/android/internal/telephony/uicc/RuimRecords$EfRuimIdLoaded;)V
    ...
    .line 927
    new-instance v1, Lcom/android/internal/telephony/uicc/RuimRecords$EfCsimMsplLoaded;

    invoke-direct {v1, p0, v5}, Lcom/android/internal/telephony/uicc/RuimRecords$EfCsimMsplLoaded;-><init>(Lcom/android/internal/telephony/uicc/RuimRecords;Lcom/android/internal/telephony/uicc/RuimRecords$EfCsimMsplLoaded;)V
    ...
    invoke-virtual {v0, v2, v6, v1}, Lcom/android/internal/telephony/uicc/IccFileHandler;->loadEFTransparent(IILandroid/os/Message;)V
    ...
    .line 931
    new-instance v1, Lcom/android/internal/telephony/uicc/RuimRecords$EfCsimMlplLoaded;

    invoke-direct {v1, p0, v5}, Lcom/android/internal/telephony/uicc/RuimRecords$EfCsimMlplLoaded;-><init>(Lcom/android/internal/telephony/uicc/RuimRecords;Lcom/android/internal/telephony/uicc/RuimRecords$EfCsimMlplLoaded;)V
...
.method private onGetCSimEprlDone(Landroid/os/AsyncResult;)V
    ...
    iput-object v2, p0, Lcom/android/internal/telephony/uicc/RuimRecords;->mEprlVersion:Ljava/lang/String;

    .line 537
    const-string/jumbo v2, "gsm.phone.hmct.eprlversion"

    iget-object v3, p0, Lcom/android/internal/telephony/uicc/RuimRecords;->mEprlVersion:Ljava/lang/String;
...
# virtual methods
.method public buildMdnString(ILjava/lang/String;)[B
    .locals 9
    ...
    .line 1161
    :cond_1
    const-string/jumbo v3, "RuimRecords"

    const-string/jumbo v4, "[buildMdnString] Empty number; set  adnString[0] =0x00"
    ...
    const-string/jumbo v4, "[buildMdnString] Max length of number is 16"
    ...
    invoke-virtual {p2, v7, v3}, Ljava/lang/String;->replace(CC)Ljava/lang/String;
    ...
    .line 1169
    invoke-static {v1, v6, v0, v6, v3}, Ljava/lang/System;->arraycopy([BI[BII)V
    ...
    const-string/jumbo v5, "[buildMdnString] bcdNumber.length is "
...
.method public getMlplVersion()Ljava/lang/String;
    .locals 1
...
.method public getMsplVersion()Ljava/lang/String;
    .locals 1
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string/jumbo v6, " Prlversion :"

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-object v6, p0, Lcom/android/internal/telephony/uicc/RuimRecords;->mPrlVersion:Ljava/lang/String;
...
.method protected onAllRecordsLoaded()V
    ...
    .line 845
    const-string/jumbo v5, "gsm.sim.hmct.cdmaImsi"
    ...
    invoke-virtual {p0, v5, v6}, Lcom/android/internal/telephony/uicc/IccRecords;->setSystemProperty(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v6, "cdmaImsi is "
    ...
    const-string/jumbo v6, "; update cdma_imsi ("
    ...
    .line 853
    iget-object v5, p0, Lcom/android/internal/telephony/uicc/RuimRecords;->mEFli:[B

    iget-object v6, p0, Lcom/android/internal/telephony/uicc/RuimRecords;->mEFpl:[B

    invoke-virtual {p0, v5, v6}, Lcom/android/internal/telephony/uicc/IccRecords;->setSimLanguage([B[B)V

    .line 856
    :cond_1
    iget-object v5, p0, Lcom/android/internal/telephony/uicc/IccRecords;->mRecordsLoadedRegistrants:Landroid/os/RegistrantList;
    ...
    invoke-virtual {v5, v2}, Lcom/android/internal/telephony/SubscriptionController;->getSubId(I)[I
    ...
    :cond_3
    const-string/jumbo v5, "Cannot call setDisplayNumber: invalid subId"
...
.method protected resetRecords()V
    ...
    const-string/jumbo v1, "reset cdma_imsi("
    ...
    .line 157
    const-string/jumbo v0, "gsm.sim.hmct.cdmaImsi"

    const-string/jumbo v1, ""

    invoke-virtual {p0, v0, v1}, Lcom/android/internal/telephony/uicc/IccRecords;->setSystemProperty(Ljava/lang/String;Ljava/lang/String;)V
...
.method public setMdnNumber(Ljava/lang/String;Landroid/os/Message;)V
    ...
    const-string/jumbo v2, "setMdnNumber for CDMA, number="
    ...
    invoke-virtual {p0, v1, p1}, Lcom/android/internal/telephony/uicc/RuimRecords;->buildMdnString(ILjava/lang/String;)[B

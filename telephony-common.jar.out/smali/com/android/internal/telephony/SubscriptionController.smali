...
.field private static final EVENT_WRITE_MSISDN_DONE:I = 0xa
...
.method private getSubInfoRecord(Landroid/database/Cursor;)Landroid/telephony/SubscriptionInfo;
    ...
    invoke-virtual {p0, p1}, Lcom/android/internal/telephony/SubscriptionController;->getIconTint(Landroid/database/Cursor;)I
    ...
    invoke-virtual {p0, p1}, Lcom/android/internal/telephony/SubscriptionController;->getIconBitmap(Landroid/database/Cursor;)Landroid/graphics/Bitmap;
    ...
    .line 327
    .local v12, "mnc":I
    invoke-direct {p0, v1}, Lcom/android/internal/telephony/SubscriptionController;->getSubscriptionCountryIso(I)Ljava/lang/String;
...
.method public addSubInfoRecord(Ljava/lang/String;I)I
    ...
    .restart local v18    # "subId":I
    .restart local v19    # "subIdCountMax":I
    :cond_f
    :try_start_a
    move-object/from16 v0, p0
    ...
    .line 875
    :try_start_b
    invoke-static/range {p2 .. p2}, Landroid/telephony/SubscriptionManager;->getSpnName(I)Ljava/lang/String;
...
.method public getSpnName(I)Ljava/lang/String;
    .locals 11
    .param p1, "slotId"    # I
    ...
    .line 1973
    .local v0, "mIsConfig_SimNameBySlot":Z
    if-eqz v0, :cond_3

    .line 1974
    iget-object v8, p0, Lcom/android/internal/telephony/SubscriptionController;->mTelephonyManager:Landroid/telephony/TelephonyManager;
    ...
    const-string/jumbo v9, "getSpnName: mIsConfig_SimNameBySlot is true; default sim name = "
    ...
    const-string/jumbo v9, " for slotid = "
    ...
    .line 1992
    .local v5, "spn_from_sim":Z
    iget-object v8, p0, Lcom/android/internal/telephony/SubscriptionController;->mTelephonyManager:Landroid/telephony/TelephonyManager;

    invoke-virtual {v8, p1}, Landroid/telephony/TelephonyManager;->getSimOperatorNameForPhone(I)Ljava/lang/String;

    move-result-object v4

    .line 1993
    .local v4, "spnFromCard":Ljava/lang/String;
    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v9, "getSpnName:  flag = "
    ...
    const-string/jumbo v9, ", spnFromCard = "
    ...
    .line 1997
    .local v1, "mcc_mnc":Ljava/lang/String;
    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v9, "getSpnName:  mcc_mnc = "
    ...
    .line 2001
    const-string/jumbo v8, "getSpnName:  return XL"
    ...
    .line 2004
    const-string/jumbo v8, "getSpnName:  return Indosat"
    ...
    .line 2007
    const-string/jumbo v8, "getSpnName:  return 3"
    ...
    .line 2009
    :cond_6
    const-string/jumbo v8, "TELKOMSEL"
    ...
    .line 2010
    const-string/jumbo v8, "getSpnName:  return Telkomsel"
    ...
    .line 2013
    const-string/jumbo v8, "getSpnName:  return Axis"
    ...
    .line 2016
    const-string/jumbo v8, "getSpnName:  return BOLT"
    ...
    .line 2022
    invoke-static {v8, v4, v9, v10}, Landroid/util/NativeTextHelper;->getLocalString(Landroid/content/Context;Ljava/lang/String;II)Ljava/lang/String;
    ...
    const-string/jumbo v9, "getSpnName: SPN found in card, name = "
    ...
    .line 2031
    .end local v1    # "mcc_mnc":Ljava/lang/String;
    .local v3, "spn":Ljava/lang/String;
    :cond_a
    const-string/jumbo v8, "medion"

    const-string/jumbo v9, "ro.hmct.custom.req"
    ...
    invoke-virtual {v8, p1}, Landroid/telephony/TelephonyManager;->getFirstNameInEfPnn(I)Ljava/lang/String;
    ...
    const-string/jumbo v9, "getSpnName:  firstpnn = "
    ...
    .line 2040
    invoke-static {v8, v2, v9, v10}, Landroid/util/NativeTextHelper;->getLocalString(Landroid/content/Context;Ljava/lang/String;II)Ljava/lang/String;
    ...
    const-string/jumbo v9, "getSpnName: SPN found use pnn name = "
    ...
    .line 2050
    .end local v2    # "pnn":Ljava/lang/String;
    .local v3, "spn":Ljava/lang/String;
    :cond_b
    iget-object v8, p0, Lcom/android/internal/telephony/SubscriptionController;->mTelephonyManager:Landroid/telephony/TelephonyManager;
    ...
    .line 2051
    .restart local v1    # "mcc_mnc":Ljava/lang/String;
    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v9, "getSpnName:  mcc/mnc of sim = "
    ...
    invoke-static {v8, v1}, Landroid/provider/SpnProvider;->getSPNByMCCMNC(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/CharSequence;
    ...
    const-string/jumbo v9, "getSpnName: SPN found in SpnProvider, name = "
    ...
    const-string/jumbo v9, "getSpnName: SPN not found in SpnProvider. slotid = "
    ...
    invoke-virtual {p0, p1, v8}, Lcom/android/internal/telephony/SubscriptionController;->getActiveSubscriptionInfoForSimSlotIndex(ILjava/lang/String;)Landroid/telephony/SubscriptionInfo;
    ...
    const-string/jumbo v9, "getSpnName: SPN from old subInfo (string), name = "
    ...
    const-string/jumbo v9, "getSpnName: SPN not found, name = "
    ...
    .line 2071
    invoke-static {v8, v3, v9, v10}, Landroid/util/NativeTextHelper;->getLocalString(Landroid/content/Context;Ljava/lang/String;II)Ljava/lang/String;
    ...
    const-string/jumbo v9, "getSpnName: SPN found from old subInfo, name = "
...
.method public setDisplayNumber(Ljava/lang/String;I)I
    ...
    const-string/jumbo v7, "[setDisplayNumber]+ subId:"
    ...
    .line 1070
    const-string/jumbo v6, "setDisplayNumber"
    ...
    .line 1086
    :cond_0
    const-string/jumbo v6, "[setDispalyNumber]- fail"
    ...
    .line 1105
    sget-object v6, Lcom/android/internal/telephony/SubscriptionController;->sPhones:[Lcom/android/internal/telephony/Phone;
    ...
    invoke-virtual {v6, p2}, Landroid/telephony/TelephonyManager;->getLine1AlphaTag(I)Ljava/lang/String;
    ...
    invoke-virtual {v6, v7, p2, v8, p1}, Landroid/os/Handler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;

    move-result-object v5

    .line 1108
    .local v5, "response":Landroid/os/Message;
    invoke-virtual {v1, v0, p1, v5}, Lcom/android/internal/telephony/Phone;->setLine1Number(Ljava/lang/String;Ljava/lang/String;Landroid/os/Message;)Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

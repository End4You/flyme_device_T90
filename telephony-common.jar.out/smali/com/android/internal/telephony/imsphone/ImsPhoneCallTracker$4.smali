...
.method public onFeatureCapabilityChanged(I[I[I)V
    ...
    const-string/jumbo v4, "onFeatureCapabilityChanged: "
    ...
    invoke-static {v4}, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->-get7(Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;)[Ljava/lang/String;
    ...
    invoke-static {v4}, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->-get6(Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;)[Z
    ...
    invoke-static {v6}, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->-get7(Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;)[Ljava/lang/String;
    ...
    const-string/jumbo v6, "onFeatureCapabilityChanged: tmpIsVolteEnabled="
    ...
    .line 2301
    const-string/jumbo v6, ", tmpIsVideoCallEnabled="
    ...
    const-string/jumbo v5, "onFeatureCapabilityChanged: notify IMS_REGISTERED"
    ...
    .line 2305
    invoke-direct {v5, v6}, Landroid/telephony/VoLteServiceState;-><init>(I)V

    invoke-virtual {v4, v5}, Lcom/android/internal/telephony/imsphone/ImsPhone;->notifyVoLteServiceStateChanged(Landroid/telephony/VoLteServiceState;)V
    ...
    invoke-static {v5}, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->-wrap4(Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;)I

    move-result v5

    invoke-virtual {v4, v5}, Landroid/telephony/ServiceState;->setRilImsRadioTechnology(I)V
    ...
    invoke-static {v6}, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->-get6(Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;)[Z

    move-result-object v6

    invoke-virtual {v4, v5, v6}, Lcom/android/internal/telephony/metrics/TelephonyMetrics;->writeOnImsCapabilities(I[Z)V
    ...
    .end local v3    # "tmpIsVolteEnabled":Z
    :cond_7
    return-void
    ...
    .restart local v2    # "tmpIsVideoCallEnabled":Z
    .restart local v3    # "tmpIsVolteEnabled":Z
    :cond_8
    iget-object v4, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker$4;->this$0:Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;

    const-string/jumbo v5, "onFeatureCapabilityChanged: notify IMS_UNREGISTERED"
    ...
    invoke-direct {v5, v8}, Landroid/telephony/VoLteServiceState;-><init>(I)V

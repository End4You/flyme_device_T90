...
.field private static final DEFAULT_LINGER_DELAY_MS:I = 0x3e8
...
.method static synthetic -wrap22(Lcom/android/server/ConnectivityService;Landroid/net/NetworkRequest;)V
    .locals 0
    .param p1, "request"    # Landroid/net/NetworkRequest;

    .prologue
    invoke-direct {p0, p1}, Lcom/android/server/ConnectivityService;->handleTimeoutNetworkRequest(Landroid/net/NetworkRequest;)V
...
.method protected constructor <init>(Landroid/content/Context;Landroid/os/INetworkManagementService;Landroid/net/INetworkStatsService;Landroid/net/INetworkPolicyManager;Landroid/net/metrics/IpConnectivityLog;)V
    ...
    const v3, #android:array@normalnetworkAttributes#t
...
.method private callCallbackForRequest(Lcom/android/server/ConnectivityService$NetworkRequestInfo;Lcom/android/server/connectivity/NetworkAgentInfo;II)V
    ...
    invoke-virtual {v3, v5, v4}, Lcom/android/server/ConnectivityService$InternalHandler;->hasMessages(ILjava/lang/Object;)Z
    ...
    const-string/jumbo v4, "remove EVENT_TIMEOUT_NETWORK_REQUEST for request "
    ...
    invoke-virtual {v3, v5, v4}, Lcom/android/server/ConnectivityService$InternalHandler;->removeMessages(ILjava/lang/Object;)V
...
.method private handleTimeoutNetworkRequest(Landroid/net/NetworkRequest;)V
    .locals 4
    .param p1, "request"    # Landroid/net/NetworkRequest;
    ...
    const-string/jumbo v2, "HISENSE handleTimeoutNetworkRequest request = "
    ...
    invoke-direct {p0, v0, v3, v1, v2}, Lcom/android/server/ConnectivityService;->callCallbackForRequest(Lcom/android/server/ConnectivityService$NetworkRequestInfo;Lcom/android/server/connectivity/NetworkAgentInfo;II)V
    ...
    const-string/jumbo v2, "HISENSE handleTimeoutNetworkRequest NULL NetworkRequestInfo for request = "
...
.method private updateNetworkInfo(Lcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/NetworkInfo;)V
    ...
    .line 5283
    .restart local v4    # "oldInfo":Landroid/net/NetworkInfo;
    :cond_1
    new-instance v7, Ljava/lang/StringBuilder;
    ...
    const v8, #android:bool@config_skip_network_validation#t
    ...
    const-string v7, "don\'t scheduleUnvalidatedPrompt"
    ...
    invoke-direct {p0, p1, v7, v2, v3}, Lcom/android/server/ConnectivityService;->rematchNetworkAndRequests(Lcom/android/server/connectivity/NetworkAgentInfo;Lcom/android/server/ConnectivityService$ReapUnvalidatedNetworks;J)V
    ...
    .line 5303
    invoke-interface {v7, v8, v9}, Landroid/os/INetworkManagementService;->createPhysicalNetwork(ILjava/lang/String;)V
    :try_end_3

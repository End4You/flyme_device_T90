...
.method public enable(Ljava/lang/String;)Z
    ...
    sget-boolean v8, Landroid/safe/SafeFeature;->ENABLE:Z

    if-eqz v8, :cond_2

    const-string v8, "mobile_safe"

    invoke-static {v8}, Landroid/os/ServiceManager;->getService(Ljava/lang/String;)Landroid/os/IBinder;

    move-result-object v4

    check-cast v4, Landroid/safe/IMobileSafe;
    ...
    invoke-interface {v4, v9, v8, v10, v11}, Landroid/safe/IMobileSafe;->checkPermission(IILjava/lang/String;Landroid/os/Bundle;)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 749
    .local v3, "mAppOpsManager":Landroid/app/AppOpsManager;
    invoke-static {}, Landroid/os/Binder;->getCallingUid()I
    ...
    invoke-virtual {v3, v9, v8, p1}, Landroid/app/AppOpsManager;->noteOp(IILjava/lang/String;)I
    ...
    .line 757
    .end local v3    # "mAppOpsManager":Landroid/app/AppOpsManager;
    ...
    .line 758
    const-string/jumbo v10, "Need BLUETOOTH ADMIN permission"
    ...
    iget-boolean v8, p0, Lcom/android/server/BluetoothManagerService;->mPermissionReviewRequired:Z

    if-eqz v8, :cond_4

    .line 762
    const-string/jumbo v8, "android.bluetooth.adapter.action.REQUEST_ENABLE"

    .line 761
    invoke-direct {p0, p1, v1, v8}, Lcom/android/server/BluetoothManagerService;->startConsentUiIfNeeded(Ljava/lang/String;ILjava/lang/String;)Z
    ...
    const-string/jumbo v9, "):  mBluetooth ="
    ...
    .line 769
    const-string/jumbo v9, " mBinding = "
    ...
    .line 770
    iget v9, p0, Lcom/android/server/BluetoothManagerService;->mState:I

    invoke-static {v9}, Landroid/bluetooth/BluetoothAdapter;->nameForState(I)Ljava/lang/String;
    ...
    invoke-direct {p0, v8, p1}, Lcom/android/server/BluetoothManagerService;->sendEnableMsg(ZLjava/lang/String;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    const-string/jumbo v8, "enable returning"

...
.field private static final UEVENT_LED_FLASH_WARNING:Ljava/lang/String; = "/sys/class/flashlightdrv/kd_camera_flashlight"

.field private static mBreathLightType:I

.field private static mWeakChgSocCheckStarted:I


# instance fields
.field private INDICATOR_CHARGING:Ljava/lang/String;

.field private INDICATOR_LOW_CHARGING:Ljava/lang/String;
...
.field private final mLedFlashObserver:Landroid/os/UEventObserver;
...
.field private mNotificationBatteryLowEnabled:Z

.field private mNotificationChargingEnabled:Z
...
# direct methods
.method static synthetic -get0(Lcom/android/server/BatteryService;)Ljava/lang/String;
    .locals 1

    iget-object v0, p0, Lcom/android/server/BatteryService;->INDICATOR_CHARGING:Ljava/lang/String;

    return-object v0
.end method

.method static synthetic -get1(Lcom/android/server/BatteryService;)Ljava/lang/String;
    .locals 1

    iget-object v0, p0, Lcom/android/server/BatteryService;->INDICATOR_LOW_CHARGING:Ljava/lang/String;
...
.method static synthetic -get12(Lcom/android/server/BatteryService;)Z
    ...
    iget-boolean v0, p0, Lcom/android/server/BatteryService;->mNotificationBatteryLowEnabled:Z
...
.method static synthetic -get13(Lcom/android/server/BatteryService;)Z
    ...
    iget-boolean v0, p0, Lcom/android/server/BatteryService;->mNotificationChargingEnabled:Z
...
.method static synthetic -get5()I
    ...
    sget v0, Lcom/android/server/BatteryService;->mBreathLightType:I
...
.method static synthetic -set1(Lcom/android/server/BatteryService;Z)Z
    ...
    iput-boolean p1, p0, Lcom/android/server/BatteryService;->mNotificationBatteryLowEnabled:Z
...
.method static synthetic -set2(Lcom/android/server/BatteryService;Z)Z
    ...
    iput-boolean p1, p0, Lcom/android/server/BatteryService;->mNotificationChargingEnabled:Z
...
.method static constructor <clinit>()V
    ...
    .line 1289
    sput v3, Lcom/android/server/BatteryService;->mBreathLightType:I
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lcom/android/server/BatteryService;->mLedFlashObserver:Landroid/os/UEventObserver;

    .line 1292
    iput-boolean v2, p0, Lcom/android/server/BatteryService;->mNotificationChargingEnabled:Z

    .line 1293
    iput-boolean v2, p0, Lcom/android/server/BatteryService;->mNotificationBatteryLowEnabled:Z

    .line 1294
    iput-boolean v2, p0, Lcom/android/server/BatteryService;->mScreenOn:Z

    .line 1295
    const-string/jumbo v1, "indicator_charging"

    iput-object v1, p0, Lcom/android/server/BatteryService;->INDICATOR_CHARGING:Ljava/lang/String;

    .line 1296
    const-string/jumbo v1, "indicator_low_charging"

    iput-object v1, p0, Lcom/android/server/BatteryService;->INDICATOR_LOW_CHARGING:Ljava/lang/String;
    ...
    .line 195
    const-string/jumbo v1, "ro.hmct.breathlight.type"

    invoke-static {v1, v3}, Landroid/os/SystemProperties;->getInt(Ljava/lang/String;I)I

    move-result v1

    sput v1, Lcom/android/server/BatteryService;->mBreathLightType:I
    ...
    :cond_1
    iget-object v1, p0, Lcom/android/server/BatteryService;->mLedFlashObserver:Landroid/os/UEventObserver;

    const-string v2, "SUBSYSTEM=leds"
...
.method private processValuesLocked(Z)V
    ...
    .line 529
    invoke-direct {p0}, Lcom/android/server/BatteryService;->shutdownIfBatteryDeadLocked()V
...
.method private shutdownIfBatteryDeadLocked()V
    .locals 3
    ...
    const-string/jumbo v2, "Battery Dead Shutdown: "
...
.method public onBootPhase(I)V
    ...
    :try_start_0
    new-instance v0, Lcom/android/server/BatteryService$5;

    iget-object v2, p0, Lcom/android/server/BatteryService;->mHandler:Landroid/os/Handler;

    invoke-direct {v0, p0, v2}, Lcom/android/server/BatteryService$5;-><init>(Lcom/android/server/BatteryService;Landroid/os/Handler;)V
    ...
    iget-object v2, p0, Lcom/android/server/BatteryService;->mSettingsObserver:Lcom/android/server/BatteryService$SettingsObserver;
...
.method public onStart()V
    ...
    new-instance v4, Lcom/android/server/BatteryService$SettingsObserver;

    iget-object v5, p0, Lcom/android/server/BatteryService;->mHandler:Landroid/os/Handler;

    invoke-direct {v4, p0, v5}, Lcom/android/server/BatteryService$SettingsObserver;-><init>(Lcom/android/server/BatteryService;Landroid/os/Handler;)V

    iput-object v4, p0, Lcom/android/server/BatteryService;->mSettingsObserver:Lcom/android/server/BatteryService$SettingsObserver;

...
.method public static getPackagesForDexopt(Ljava/util/Collection;Lcom/android/server/pm/PackageManagerService;)Ljava/util/List;
    ...
    const-string/jumbo v12, "Looking at historical package use"
    ...
    const-string/jumbo v13, "Taking package "
    ...
    const-string/jumbo v13, " as reference in time use"
    ...
    const-string/jumbo v13, "Packages to be dexopted: "
    ...
    const-string/jumbo v13, "Packages skipped from dexopt: "

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v12

    invoke-static {v7}, Lcom/android/server/pm/PackageManagerServiceUtils;->packagesToString(Ljava/util/Collection;)Ljava/lang/String;

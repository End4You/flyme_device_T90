...
.method private runUninstall()I
    ...
    invoke-direct {v0, v2, v15}, Lcom/android/server/pm/PackageManagerShellCommand;->runRemoveSplit(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-interface {v1, v2, v3, v6}, Landroid/content/pm/IPackageManager;->getPackageInfo(Ljava/lang/String;II)Landroid/content/pm/PackageInfo;

    move-result-object v9

    .line 796
    .local v9, "info2":Landroid/content/pm/PackageInfo;
    if-nez v9, :cond_6
    ...
    invoke-direct {v13, v1}, Lcom/android/server/pm/PackageManagerShellCommand$LocalIntentReceiver;-><init>(Lcom/android/server/pm/PackageManagerShellCommand$LocalIntentReceiver;)V
    ...
    invoke-interface/range {v1 .. v6}, Landroid/content/pm/IPackageInstaller;->uninstall(Ljava/lang/String;Ljava/lang/String;ILandroid/content/IntentSender;I)V
    ...
    .line 812
    invoke-virtual {v14, v1, v3}, Landroid/content/Intent;->getIntExtra(Ljava/lang/String;I)I
    ...
    .line 779
    .end local v9    # "info2":Landroid/content/pm/PackageInfo;
    ...
    const-string/jumbo v3, "Failure [not installed for "
    ...
    .restart local v9    # "info2":Landroid/content/pm/PackageInfo;
    :cond_b
    new-instance v1, Ljava/lang/StringBuilder;
    ...
    .line 818
    .restart local v13    # "receiver":Lcom/android/server/pm/PackageManagerShellCommand$LocalIntentReceiver;
    .restart local v14    # "result":Landroid/content/Intent;

...
#-----------------------------------------------------------------------------
vendor_saved_apps := Bluetooth BluetoothExt BluetoothMidiService EasterEgg ExtShared HTMLViewer KeyChain \
...
override_property += \
    ro.flyme.romer=bottle \
    ro.product.model_romer=T90_Unofficial

...
.field static final TRANSACTION_getVendorAppInstalledState:I = 0xab
...
.field static final TRANSACTION_isPackageAlive:I = 0xaa
...
.field static final TRANSACTION_isPackageRestricted:I = 0xa7
...
.field static final TRANSACTION_isRestrictedAvailable:I = 0xa8
...
.field static final TRANSACTION_setPackageAliveState:I = 0xa9

.field static final TRANSACTION_setPackageRestrictState:I = 0xa6
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 128
    .local v97, "_result":[Ljava/lang/String;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .end local v97    # "_result":[Ljava/lang/String;
    :sswitch_7
    const-string/jumbo v6, "android.content.pm.IPackageManager"
    ...
    .line 138
    .restart local v97    # "_result":[Ljava/lang/String;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .local v58, "_arg1":Landroid/content/Intent;
    goto :goto_a

    .line 278
    .end local v58    # "_arg1":Landroid/content/Intent;
    ...
    check-cast v48, Landroid/content/pm/PermissionInfo;
    ...
    .local v48, "_arg0":Landroid/content/pm/PermissionInfo;
    goto :goto_12

    .line 394
    .end local v48    # "_arg0":Landroid/content/pm/PermissionInfo;
    .restart local v94    # "_result":Z
    :cond_13
    const/4 v6, 0x0
    ...
    .line 535
    .local v93, "_result":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 541
    .end local v93    # "_result":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    :sswitch_21
    const-string/jumbo v6, "android.content.pm.IPackageManager"
    ...
    .line 928
    .local v51, "_arg0":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    ...
    .line 929
    .local v64, "_arg1":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/ProviderInfo;>;"
    move-object/from16 v0, p0
    ...
    .line 937
    .end local v51    # "_arg0":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .end local v64    # "_arg1":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/ProviderInfo;>;"
    :sswitch_36
    const-string/jumbo v6, "android.content.pm.IPackageManager"
    ...
    .line 1043
    .local v61, "_arg1":Landroid/content/pm/IPackageDeleteObserver;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .end local v9    # "_arg2":I
    .end local v10    # "_arg3":I
    .end local v61    # "_arg1":Landroid/content/pm/IPackageDeleteObserver;
    :sswitch_3d
    const-string/jumbo v6, "android.content.pm.IPackageManager"
    ...
    .line 1058
    .local v60, "_arg1":Landroid/content/pm/IPackageDeleteObserver2;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .end local v9    # "_arg2":I
    .end local v10    # "_arg3":I
    .end local v60    # "_arg1":Landroid/content/pm/IPackageDeleteObserver2;
    :sswitch_3e
    const-string/jumbo v6, "android.content.pm.IPackageManager"
    ...
    .line 1212
    .local v49, "_arg0":Ljava/util/List;, "Ljava/util/List<Landroid/content/IntentFilter;>;"
    new-instance v63, Ljava/util/ArrayList;

    invoke-direct/range {v63 .. v63}, Ljava/util/ArrayList;-><init>()V

    .line 1214
    .local v63, "_arg1":Ljava/util/List;, "Ljava/util/List<Landroid/content/ComponentName;>;"
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readString()Ljava/lang/String;
    ...
    .line 1224
    .end local v40    # "_arg2":Ljava/lang/String;
    .end local v49    # "_arg0":Ljava/util/List;, "Ljava/util/List<Landroid/content/IntentFilter;>;"
    .end local v63    # "_arg1":Ljava/util/List;, "Ljava/util/List<Landroid/content/ComponentName;>;"
    .end local v75    # "_result":I
    :sswitch_46
    const-string/jumbo v6, "android.content.pm.IPackageManager"
    ...
    check-cast v55, Landroid/content/ComponentName;
    ...
    .local v55, "_arg1":Landroid/content/ComponentName;
    goto :goto_3c

    .line 1247
    .end local v55    # "_arg1":Landroid/content/ComponentName;
    :sswitch_47
    const-string/jumbo v6, "android.content.pm.IPackageManager"
    ...
    .line 1404
    .local v50, "_arg0":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    move-object/from16 v0, p0
    ...
    .line 1418
    .end local v50    # "_arg0":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    ...
    .line 1575
    .local v59, "_arg1":Landroid/content/pm/IPackageDataObserver;
    move-object/from16 v0, p0
    ...
    .line 1581
    .end local v7    # "_arg0":Ljava/lang/String;
    .end local v59    # "_arg1":Landroid/content/pm/IPackageDataObserver;
    :sswitch_60
    const-string/jumbo v6, "android.content.pm.IPackageManager"
    ...
    .line 1600
    .restart local v59    # "_arg1":Landroid/content/pm/IPackageDataObserver;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .line 1780
    .end local v52    # "_arg0":Z
    .end local v65    # "_arg1":Z
    :cond_51
    const/16 v52, 0x0

    .restart local v52    # "_arg0":Z
    goto :goto_51
    ...
    check-cast v47, Landroid/content/pm/PackageCleanItem;
    ...
    .local v47, "_arg0":Landroid/content/pm/PackageCleanItem;
    goto :goto_53

    .line 1804
    .end local v47    # "_arg0":Landroid/content/pm/PackageCleanItem;
    ...
    .line 1823
    .local v46, "_arg0":Landroid/content/pm/IPackageMoveObserver;
    move-object/from16 v0, p0
    ...
    .line 1829
    .end local v46    # "_arg0":Landroid/content/pm/IPackageMoveObserver;
    :sswitch_77
    const-string/jumbo v6, "android.content.pm.IPackageManager"
    ...
    .line 1832
    .restart local v46    # "_arg0":Landroid/content/pm/IPackageMoveObserver;
    move-object/from16 v0, p0
    ...
    .restart local v48    # "_arg0":Landroid/content/pm/PermissionInfo;
    goto :goto_55
    ...
    check-cast v62, Landroid/content/pm/KeySet;
    ...
    .local v62, "_arg1":Landroid/content/pm/KeySet;
    goto :goto_6c

    .line 2195
    .end local v62    # "_arg1":Landroid/content/pm/KeySet;
    .restart local v94    # "_result":Z
    :cond_6d
    const/4 v6, 0x0
    ...
    .restart local v62    # "_arg1":Landroid/content/pm/KeySet;
    goto :goto_6e
    ...
    .line 2220
    .local v45, "_arg0":Landroid/content/pm/IOnPermissionsChangeListener;
    move-object/from16 v0, p0
    ...
    .line 2226
    .end local v45    # "_arg0":Landroid/content/pm/IOnPermissionsChangeListener;
    :sswitch_98
    const-string/jumbo v6, "android.content.pm.IPackageManager"
    ...
    .line 2229
    .restart local v45    # "_arg0":Landroid/content/pm/IOnPermissionsChangeListener;
    move-object/from16 v0, p0
    ...
    .line 2316
    .local v91, "_result":Landroid/graphics/Bitmap;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .end local v7    # "_arg0":Ljava/lang/String;
    .end local v34    # "_arg1":I
    .end local v91    # "_result":Landroid/graphics/Bitmap;
    :sswitch_a0
    const-string/jumbo v6, "android.content.pm.IPackageManager"
    ...
    .line 2382
    .restart local v93    # "_result":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    invoke-virtual {v0, v7, v1, v9}, Landroid/content/pm/IPackageManager$Stub;->setPackageRestrictState(Ljava/lang/String;ZI)Z
    ...
    invoke-virtual {v0, v7, v1}, Landroid/content/pm/IPackageManager$Stub;->isPackageRestricted(Ljava/lang/String;I)Z
    ...
    invoke-virtual {v0, v7}, Landroid/content/pm/IPackageManager$Stub;->isRestrictedAvailable(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, v7, v8, v1, v10}, Landroid/content/pm/IPackageManager$Stub;->setPackageAliveState(Ljava/lang/String;Ljava/lang/String;ZI)V
    ...
    invoke-virtual {v0, v7, v1}, Landroid/content/pm/IPackageManager$Stub;->isPackageAlive(Ljava/lang/String;I)Z
    ...
    invoke-virtual {v0, v1}, Landroid/content/pm/IPackageManager$Stub;->getVendorAppInstalledState(Landroid/content/pm/ApplicationInfo;)Z
    ...
    .local v44, "_arg0":Landroid/content/pm/ApplicationInfo;
    goto :goto_7e

    .line 2461
    .end local v44    # "_arg0":Landroid/content/pm/ApplicationInfo;
    .restart local v94    # "_result":Z
    :cond_7f
    const/4 v6, 0x0

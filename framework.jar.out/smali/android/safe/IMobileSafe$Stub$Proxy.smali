...
.method public addPermission(Landroid/safe/PackageInfoEx;)V
    ...
    :try_start_0
    const-string/jumbo v2, "android.safe.IMobileSafe"
    ...
    invoke-virtual {p1, v0, v2}, Landroid/safe/PackageInfoEx;->writeToParcel(Landroid/os/Parcel;I)V
...
.method public checkPermission(IILjava/lang/String;Landroid/os/Bundle;)I
    ...
    .local v1, "_reply":Landroid/os/Parcel;
    :try_start_0
    const-string/jumbo v3, "android.safe.IMobileSafe"
...
.method public getAllPackageInfoEx()Ljava/util/List;
    ...
    .line 335
    sget-object v3, Landroid/safe/PackageInfoEx;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    .line 338
    .local v2, "_result":Ljava/util/List;, "Ljava/util/List<Landroid/safe/PackageInfoEx;>;"
    invoke-virtual {v1}, Landroid/os/Parcel;->recycle()V
    ...
    .line 337
    .end local v2    # "_result":Ljava/util/List;, "Ljava/util/List<Landroid/safe/PackageInfoEx;>;"
    :catchall_0
    move-exception v3
...
.method public getAssociatePkgAndState()Ljava/util/List;
    ...
    .line 446
    sget-object v3, Landroid/safe/AutoRunPkgInfo;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    .line 449
    .local v2, "_result":Ljava/util/List;, "Ljava/util/List<Landroid/safe/AutoRunPkgInfo;>;"
    invoke-virtual {v1}, Landroid/os/Parcel;->recycle()V
    ...
    .line 448
    .end local v2    # "_result":Ljava/util/List;, "Ljava/util/List<Landroid/safe/AutoRunPkgInfo;>;"
    :catchall_0
    move-exception v3
...
.method public getPackageInfoExByUid(I)Landroid/safe/PackageInfoEx;
    ...
    check-cast v2, Landroid/safe/PackageInfoEx;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .local v2, "_result":Landroid/safe/PackageInfoEx;
    goto :goto_0

    .line 360
    .end local v2    # "_result":Landroid/safe/PackageInfoEx;
    :catchall_0
    move-exception v3

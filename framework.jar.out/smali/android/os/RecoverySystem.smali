...
.field public static final DEVICE_AUTHORITY_CONFIG_FILE:Ljava/lang/String; = "sys/devices/platform/aboot/lk_authority"

.field public static final DEVICE_ROOT_CONFIG_FILE:Ljava/lang/String; = "sys/devices/platform/aboot/lk_root"
...
.field public static final OTA_UPGRAGE_PACKAGE_PATH:Ljava/lang/String; = "/cache/recovery/last_ota_package_info"
...
.field private static final VALID_CACHE:J = 0x6400000L
...
.method private static varargs bootCommand(Landroid/content/Context;[Ljava/lang/String;)V
    ...
    .line 917
    invoke-static {}, Landroid/os/RecoverySystem;->clearCachePartition()V
    ...
    invoke-static {v3}, Landroid/os/RecoverySystem;->writeCommandToFile(Ljava/lang/String;)V
...
.method static clearCachePartition()V
    .locals 8
    ...
    .line 499
    invoke-static {}, Landroid/os/RecoverySystem;->getAvailableCache()J
    ...
    const-string/jumbo v5, "get remainingSize of cache\n"
    ...
    invoke-static {v4}, Landroid/service/cachebackup/ICacheBackupDeleteService$Stub;->asInterface(Landroid/os/IBinder;)Landroid/service/cachebackup/ICacheBackupDeleteService;

    move-result-object v0

    .line 504
    .local v0, "cacheBackup":Landroid/service/cachebackup/ICacheBackupDeleteService;
    if-eqz v0, :cond_0
    ...
    const-string/jumbo v5, "cacheBackup is not null\n"

    invoke-static {v4, v5}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 506
    invoke-interface {v0}, Landroid/service/cachebackup/ICacheBackupDeleteService;->clearCacheBackup()V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    .line 512
    .end local v0    # "cacheBackup":Landroid/service/cachebackup/ICacheBackupDeleteService;
    :cond_0
    :goto_0
    invoke-static {}, Landroid/os/RecoverySystem;->getAvailableCache()J
    ...
    const-string/jumbo v5, "cacheBackup successed\n"
    ...
    .line 508
    .restart local v0    # "cacheBackup":Landroid/service/cachebackup/ICacheBackupDeleteService;
    :catch_0
    move-exception v1
    ...
    const-string/jumbo v5, "cacheBackup has exception\n"
...
.method private static getAvailableCache()J
    .locals 8
    ...
    const-string/jumbo v5, "[getAvailableCache]"
    ...
    const-string/jumbo v6, "[getAvailableCache]remaining="
...
.method public static installPackage(Landroid/content/Context;Ljava/io/File;Z)V
    ...
    const-string/jumbo v12, "sys.monkey.enabled"
    ...
    const-string/jumbo v12, "Monkey test is Running--installPackage--return"
    ...
    const-string/jumbo v12, "installPackage normal process"
    ...
    .restart local v3    # "isMonkeyMode":Z
...
.method public static installPackageHmct(Landroid/content/Context;Ljava/lang/String;)V
    .locals 21
    .param p0, "context"    # Landroid/content/Context;
    .param p1, "packageFileArg"    # Ljava/lang/String;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
    ...
    .prologue
    .line 626
    sget-object v18, Landroid/os/RecoverySystem;->sRequestLock:Ljava/lang/Object;
    ...
    const-string/jumbo v19, "sys.monkey.enabled"
    ...
    const-string/jumbo v19, "Monkey test is Running--installPackageHmct--return"
    ...
    const-string/jumbo v19, "installPackageHmct normal process"
    ...
    const-string/jumbo v20, "!!!framework installPackageHmct: packageFileArg "
    ...
    const-string/jumbo v17, "file_path"
    ...
    .line 647
    .local v6, "filename":Ljava/lang/String;
    const-string/jumbo v17, "upgrade_auto"
    ...
    .line 653
    .end local v3    # "autoUpgrade":Z
    .end local v6    # "filename":Ljava/lang/String;
    .end local v9    # "js":Lorg/json/JSONObject;
    :goto_0
    if-nez v6, :cond_2
    ...
    :cond_2
    :try_start_3
    invoke-static {v6}, Landroid/os/RecoverySystem;->parseOTAFile(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v17, "/cache/recovery/last_ota_package_info"
    ...
    .line 664
    .local v11, "otaVersionFile":Ljava/io/FileWriter;
    :try_start_4
    ...
    const-string/jumbo v20, "!!! REBOOTING TO INSTALL "
    ...
    .line 688
    const-string/jumbo v6, "@/cache/recovery/block.map"
    ...
    const-string/jumbo v19, "--update_package="
    ...
    .line 692
    .local v7, "filenameArg":Ljava/lang/String;
    new-instance v17, Ljava/lang/StringBuilder;

    invoke-direct/range {v17 .. v17}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v19, "--upgrade_auto="
    ...
    .line 694
    .local v15, "upgradeArg":Ljava/lang/String;
    new-instance v17, Ljava/lang/StringBuilder;
    ...
    invoke-static {v4}, Landroid/os/RecoverySystem;->writeCommandToFile(Ljava/lang/String;)V
    ...
    check-cast v13, Landroid/os/RecoverySystem;

    .line 699
    .local v13, "rs":Landroid/os/RecoverySystem;
    invoke-direct {v13, v4}, Landroid/os/RecoverySystem;->setupBcb(Ljava/lang/String;)Z
    ...
    const-string/jumbo v19, "Setup BCB failed"
    ...
    .end local v7    # "filenameArg":Ljava/lang/String;
    .end local v8    # "isMonkeyMode":Z
    .end local v10    # "localeArg":Ljava/lang/String;
    .end local v11    # "otaVersionFile":Ljava/io/FileWriter;
    .end local v13    # "rs":Landroid/os/RecoverySystem;
    .end local v15    # "upgradeArg":Ljava/lang/String;
    ...
    .line 648
    .restart local v3    # "autoUpgrade":Z
    .restart local v8    # "isMonkeyMode":Z
    :catch_0
    move-exception v5
    ...
    const-string/jumbo v20, "[installPackageHmct get json]"
    ...
    .restart local v11    # "otaVersionFile":Ljava/io/FileWriter;
    ...
    const-string/jumbo v20, "Error setting permission for "
    ...
    .restart local v7    # "filenameArg":Ljava/lang/String;
    .restart local v10    # "localeArg":Ljava/lang/String;
    .restart local v13    # "rs":Landroid/os/RecoverySystem;
    .restart local v15    # "upgradeArg":Ljava/lang/String;
    :cond_5
    ...
    const-string/jumbo v17, "recovery-update"

    move-object/from16 v0, v17

    invoke-virtual {v12, v0}, Landroid/os/PowerManager;->reboot(Ljava/lang/String;)V

    .line 707
    new-instance v17, Ljava/io/IOException;

    const-string/jumbo v19, "Reboot failed (no permissions?)"
...
.method public static isRoot()Z
    ...
    .prologue
    .line 485
    const-string/jumbo v1, "sys/devices/platform/aboot/lk_root"

    invoke-static {v1}, Landroid/os/RecoverySystem;->readConfigFile(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    .line 486
    .local v0, "lkroot":Ljava/lang/String;
    if-eqz v0, :cond_0
...
.method public static isUnAuth()Z
    .locals 2

    .prologue
    .line 492
    const-string/jumbo v1, "sys/devices/platform/aboot/lk_authority"
    ...
    .line 493
    .local v0, "lkauthority":Ljava/lang/String;
    if-eqz v0, :cond_0
...
.method private static parseOTAFile(Ljava/lang/String;)Ljava/lang/String;
    .locals 7
    .param p0, "OtaPackageName"    # Ljava/lang/String;
    ...
    const-string/jumbo v6, "[OtaPackageName ]"
    ...
    const-string/jumbo v6, "parseOTAFile res="
...
.method private static readConfigFile(Ljava/lang/String;)Ljava/lang/String;
    .locals 7
    .param p0, "rootconfig"    # Ljava/lang/String;
    ...
    const-string/jumbo v6, "readConfigFile:"
    ...
    .line 465
    .local v0, "bufr":Ljava/lang/String;
    :try_start_0
    ...
    .line 475
    .end local v0    # "bufr":Ljava/lang/String;
    ...
    const-string/jumbo v6, "[readConfigFile]Reading :"
    ...
    const-string/jumbo v6, "[readConfigFile]IOException error:"
    ...
    const-string/jumbo v6, "[readConfigFile]FileNotFoundException error "
...
.method public static rebootWipeUserData(Landroid/content/Context;ZLjava/lang/String;Z)V
    ...
    const-string/jumbo v2, "Monkey test is Running--rebootWipeUserData--return"
    ...
    const-string/jumbo v2, "rebootWipeUserData normal process"
...
.method private static writeCommandToFile(Ljava/lang/String;)V
    .locals 5
    ...
    const-string/jumbo v4, "writeCommandToFile command: ["
    ...
    .line 1077
    .local v0, "commandFile":Ljava/io/FileWriter;
    :try_start_0
    ...
    const-string/jumbo v3, "writeCommandToFile has exception\n"
